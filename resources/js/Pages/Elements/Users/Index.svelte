<script>
// resources/js/Pages/Elements/Users/Index.svelte
    ...
    //import CreateUserForm from '@pages/Elements/Users/Forms/StoreSingle.svelte';
    import ModalAddBody from '@pages/Elements/Users/Modal/Add/Body.svelte';
    //import ModalShowBody from '@pages/Elements/Users/Modal/Show/Body.svelte';
    ...
    import SubtasksDatatable from '@pages/Elements/Users/SubtasksDatatable.svelte';
    import LinkViewModal from '@pages/Elements/Users/Show/Modal.svelte';
    ...
    <ContextNav {navItems}>
        <div class="context-actions" slot="actions">
            ...
            <ModalBox
                bind:this={modal}
            >
                <span slot="title">{$t('Add A User')}</span>
